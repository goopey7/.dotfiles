...
globalkeys = my_table.join(
    ...
    -- super + ... function keys
    awful.key({ modkey }, "F1", function () awful.util.spawn( "brave https://mylearningspace.abertay.ac.uk" ) end,
        {description = browser1, group = "function keys"}),
...
clientkeys = my_table.join(
    ...
    awful.key({ altkey,"Shift" },           "x",      function (c) c:kill()                         end,
              {description = "close", group = "hotkeys"}),
